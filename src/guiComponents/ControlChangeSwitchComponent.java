...
public class ControlChangeSwitchComponent extends Composite {
	...
	public ControlChangeSwitchComponent(Composite parent, int style) {
		super(parent, style);
	...
	public ControlChangeSwitchComponent(Composite parent, int style, DataStructure data) {
		super(parent, style);
